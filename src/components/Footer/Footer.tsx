...
const Footer = () => {
  return (
    <footer className="footer footer-center mt-24 p-4 bg-base-300 text-base-content flex flex-col justify-between items-center text-center">
      <div>
        ...
        <div className="pt-3 flex flex-wrap gap-3">
          ...
          <Link to={"https://twitter.com/Reza6f9"} className="hover:bg-red-50">
            <button className="btn btn-circle text-[#1A8CD8] hover:bg-[#1A8CD8] hover:text-white">
              <FaTwitterSquare className="h-12 w-12" />
            </button>
          </Link>
        </div>
      </div>
